...
属性：
 ...
 [`upload`](https://developer.mozilla.org/zh-CN/docs/Web/API/XMLHttpRequest/upload)返回 [`XMLHttpRequestUpload`](https://developer.mozilla.org/zh-CN/docs/Web/API/XMLHttpRequestUpload)对象，用来表示上传的进度
